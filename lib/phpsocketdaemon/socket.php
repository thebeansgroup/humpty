...
abstract class socket {
    ...
    public function write($buffer, $length = 4096)
    {
        if (!is_resource($this->socket)) {
            ...
            // throwing this exception stops the client working
            // on other machines
    ...
    /**
     * Listen for a connection on the configured interface
     * 
     ...
     * 
     * @return resource Returns a new socket resource on success, or FALSE on error.
     */
    ...
    /**
     * Set the timeout for receive operations on the socket
     * 
     * @param int $sec The max number of seconds to wait
     * @param int $usec The max number of microseconds to wait
     * @return bool
     */
